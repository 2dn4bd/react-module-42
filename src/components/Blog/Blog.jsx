...
import './BLog.css'
const Blog = ({blogs, handleAddToBookmark, handleMarkAsRead}) => {
    ...
    return (
        <div className='mb-20 space-y-2'>
            ...
            <button onClick={()=>handleMarkAsRead(reading_time) } className='text-blue-600 underline font-bold'>Mark As Read</button>
        </div>
    );
};
Blog.propTypes = {
